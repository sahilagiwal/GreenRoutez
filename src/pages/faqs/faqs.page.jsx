...
const FAQ = () => {
    ...
    const [style, setStyle] = useState(["panel-hide","panel-hide","panel-hide"]);
    ...
    return (
      ...
      >
        ...
        {/* the questeions (container not working) */}
            ...
            >How do I get a ride?<b className='sign'>{sign[0]}</b></motion.div>
            <div class={style[0]}>
            ...
            >How do I share my car?<b className='sign'>{sign[1]}</b></motion.div>
            <div class={style[1]}>
            ...
            >Where do the profits of this app go?<b className='sign'>{sign[2]}</b></motion.div>
            <div class={style[2]}>
